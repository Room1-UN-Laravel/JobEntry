			...
			<div class="row">
				<div class="col-md-12 col-sm-12 ">
					<div class="x_panel">
						...
						<div class="x_content">
							<br />
        <form action="{{route('jobs.update', $job->id)}}" method="POST" class="px-md-5" class="form-horizontal form-label-left" enctype="multipart/form-data">
          @csrf
          @method('PUT') 
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="number" step="0.1" placeholder="Enter Salary" class="form-control py-2" name="min_salary" value="{{old('min_salary', $job->min_salary)}}" />
              @error('min_salary')
              <div class="alert alert-warning">{{$message}}</div>
              @enderror
            </div>
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="number" step="0.1" placeholder="Maximum Salary" class="form-control py-2" name="max_salary" value="{{old('max_salary', $job->max_salary)}}" />
