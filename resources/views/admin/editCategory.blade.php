							...
							<form method="POST" action="{{route('categories.update',$category['id'])}}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
								...
								<div class="form-group mb-3 row">
									...
									<div class="col-md-6 col-sm-6 ">
										<input type="text" id="add-category" required="required" class="form-control " name="name" value='{{old("name",$category["name"])}}'>
										@error('name')
								...
								<div class="form-group mb-3 row">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea id="description" name="description" required="required" class="form-control">{{old("description",$category["description"])}}</textarea>
												@error('description')
												<div class="alert alert-warning">{{$message}}</div>
												@enderror
											</div>
